...
export default function Sidebar() {
  ...
  const navItems = [
    ...
    { 
      name: isAdmin ? 'Inventory' : (isCompany ? 'Portfolio' : 'Properties'), 
      href: isAdmin ? '/admin/properties' : (isCompany ? '/portfolio' : '/properties'), 
      icon: 'M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6', 
      color: 'from-purple-500 to-pink-500', 
      activeText: 'text-purple-400', 
      activeBg: 'bg-purple-500/15 border-purple-500/25' 
    },
    (isAdmin || isCompany) && {
      name: 'Intelligence',
    ...
    { name: 'Deals', href: '/deals', icon: 'M9 12l2 2 4-4M7.835 4.697a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806 3.42 3.42 0 01-4.438 0 3.42 3.42 0 00-1.946-.806 3.42 3.42 0 01-3.138-3.138z', color: 'from-amber-500 to-orange-500', activeText: 'text-amber-400', activeBg: 'bg-amber-500/15 border-amber-500/25' },
